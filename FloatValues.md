In NL-X float values can be used in a few places at the moment. They are part of the "Write" function (as a parameter), ClientSpeed (as a parameter), and FOV (as a parameter).
